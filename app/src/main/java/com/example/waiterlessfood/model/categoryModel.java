...
public class categoryModel {
    ...
    public categoryModel(String time) {
        this.time = time;
    }
...
//    }
    ...
    public categoryModel(String catagary, String description, String date, String pname, String price, String quantity, String time, String table, String pid, String seatNo, String user_contact) {
        this.catagary = catagary;
        this.description = description;
        this.date = date;
        this.pname = pname;
